...
Accepts voice commands (via Web Speech API) and text for accessibility.

Intelligent Triage

Provides verified medical guidance and detects early health or stress symptoms.

Multilingual Support

Designed for accessibility, addressing language barriers for regional users.
...
Allows users to book appointments across Hospitals and Departments.

Cascading Selectors

Dynamic, validated forms based on State, District, Hospital, and Department.

Security & Confirmation

Includes OTP verification logic for phone numbers and generates a downloadable PDF appointment slip using jspdf and html2canvas.
...
Custom CSS (Responsive, Clean UI) and Tailwind CSS (for games)

Services (Backend)

Google Apps Script (GAS): Used as a serverless API endpoint for form submission and potential OTP/data services

Data Storage

Local Storage (for basic demo/bookings list), Firestore/Firebase (for coin/point tracking in games)

Key Libraries

html2canvas, jspdf (for PDF generation), Web Speech API
...
git clone [https://github.com/YourUsername/ChikitsaMitra.git](https://github.com/YourUsername/ChikitsaMitra.git)
cd ChikitsaMitra
